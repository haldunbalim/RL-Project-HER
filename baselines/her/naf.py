...
class NAF(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        self.create_naf_network = import_function("baselines.her.naf_utils.naf_network:Network")
    ...
    def _create_network(self, reuse=False):
        ...
        with tf.variable_scope('main') as vs:
            if reuse:
                vs.reuse_variables()
            self.main = self.create_naf_network(batch_tf, net_type='main', **self.__dict__)
            vs.reuse_variables()
        with tf.variable_scope('target') as vs:
            ...
            self.target = self.create_naf_network(
